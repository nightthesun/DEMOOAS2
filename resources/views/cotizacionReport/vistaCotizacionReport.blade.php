      ...
      <form method="GET" action="{{ route('Cotizacion.store') }}">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-12">
            ...
            <div class="mb-2 row d-flex justify-content-center">
              ...
              @if (Auth::user()->tienePermiso(29, 4))
              <div class="col-sm-6">
                <div class="dropdown">
                    ...
                    <li>
                      <a class="option-link multi-select-op" href="#">
                        <label>
                          ...
                          @if (Auth::user()->dbiz_user == $key->codigoX)
                          <input name='options[]' checked type="checkbox" class="optionI justone" value='{{$key->nombreX}}'/>
                          {{$key->nombreX}}
                          @endif
                          @endforeach
                        </label>
        ...
        <div class="mb-3 row">
          <div class="col-md-12 d-flex justify-content-center">
            ...
            @if (Auth::user()->tienePermiso(29, 12))
