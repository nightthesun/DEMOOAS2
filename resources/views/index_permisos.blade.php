  ...
  <div class="container w-75 p-5">
    <div class="row p-4 border rounded">
      <div class="col-lg-3  col-md-6 col-sm-6 col-xs-6 py-2 px-4 border-dark" data-toggle="tooltip" data-placement="top" title="Planificaciones">
        <a href="{{route('licencia.create')}}" style="text-decoration: none;">
          <div class="card imc h-100 border text-center" style="background-color: #fff;">
            <div class="container d-flex justify-content-center px-0">
              <img class="card-img-top" src="{{ asset('imagenes/forms/4.jpg') }}" alt="img">
            </div>
            <div class="card-body px-2 py-2">
              <p class="mb-0 " style="overflow: hidden;">Formulario de Licencia</p>
            </div>
          </div>
        </a>
      </div>
      ...
      <div class="col-lg-3  col-md-6 col-sm-6 col-xs-6 py-2 px-4 border-dark" data-toggle="tooltip" data-placement="top" title="Planificaciones">
        <a href="{{route('licencia.index')}}" style="text-decoration: none;">
          <div class="card imc h-100 border text-center" style="background-color: #fff;">
            <div class="container d-flex justify-content-center px-0">
              <img class="card-img-top" src="{{ asset('imagenes/forms/1.jpg') }}" alt="img">
            </div>
            <div class="card-body px-2 py-2">
              <p class="mb-0 " style="overflow: hidden;">Formularios de Permisos Enviados</p>
            </div>
          </div>
        </a>
      </div>
